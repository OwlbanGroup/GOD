# Enhance Your Connection - Implementation Progress
...
- [ ] 6. `src/index.js` - Import & init spiritual tracker
- [ ] 7. `src/core/app.js` - Init spiritual tracker in modules
- [ ] 8. `script.js` - Wire prayer/command callbacks
